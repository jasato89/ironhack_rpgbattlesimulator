...
import com.ironhack.rpg_simulator.classes.resources.Resources;
...
public class MenuManager {
    ...
    //This menu appears when we choose a fight with customs or randoms teams
    public void modeMenu() throws IOException, InterruptedException {
        ...
        switch (Resources.validateIntMenu("Choose a correct option ", "1|2|3")) {
            case 1 -> showBattleMenu();
            case 2 -> fastBattleMenu();
            default -> mainMenu();
        }
    }
    ...
    public void selectTeamsFromDatabaseMenu() throws IOException, InterruptedException {
        ...
        for (Party party : storedParties.getPartyList()) {
            if (i == selectionA) {   //We don't want to print the Team A selected
                //We can't change 'i' because we use it on the print so we change the selection for Team A
        ...
        //We need to recover the selection of Team A to select correctly the Team B from storedParties
    ...
    public void createTeamMenu() throws IOException, InterruptedException {
        ...
        for (int i = 0; i < size; i++) {
            Output.printHeader("Creation of member " + (i+1), false);
            Thread.sleep(1000);
    ...
    public Character createCharacterMenu() throws IOException, InterruptedException {
        ...
        Output.printHeader("Introduce fighter name", false);
        name = Resources.validateStringMenu("Name must only contain letters. Please choose a valid name:", "[a-zA-ZÀ-ÿ\\u00f1\\u00d1\\s]+");

        Output.printHeader("Choose 1 for a Warrior or 2 a Wizard", false);
        ...
        Output.printHeader("Health", false);
        switch (className) {
            case "Warrior" -> {
                String warriorHealthString = "Choose the health for your warrior, it should be between " +
                        RandomDatabaseGenerator.getHpWarriorMin() + " and " + RandomDatabaseGenerator.getHpWarriorMax();
            ...
            case "Wizard" -> {
                String wizardHealthString = "Choose the health for your Wizard, it should be between " +
                        RandomDatabaseGenerator.getHpWizardMin() + " and " + RandomDatabaseGenerator.getHpWizardMax();
        ...
        switch (className) {
            case "Warrior" -> {
                String staminaString = "Add stamina to your warrior, it should be between " +
                        RandomDatabaseGenerator.getStaminaMin() + " and " + RandomDatabaseGenerator.getStaminaMax();
                ...
                String strengthString = "Add Strength to your warrior, it should be between " +
                        RandomDatabaseGenerator.getStrengthMin() + " and " + RandomDatabaseGenerator.getStrengthMax();
            ...
            case "Wizard" -> {
                String manaString = "Add Mana to your Wizard, it should be between " +
                        RandomDatabaseGenerator.getManaMin() + " and " + RandomDatabaseGenerator.getManaMax();
                ...
                String intelligenceString = "Add Intelligence to your Wizard, it should be between " +
                        RandomDatabaseGenerator.getIntelligenceMin() + " and " + RandomDatabaseGenerator.getIntelligenceMax();
    ...
    public void showBattleMenu() throws IOException, InterruptedException {
        ...
        while (sizeParty1 > 0 && sizeParty2 > 0 && graveyardOption == 1) {
            ...
            sizeParty1 = battle.getParty1().getAliveMembers().size();
            sizeParty2 = battle.getParty2().getAliveMembers().size();
            if (sizeParty1 > 0 && sizeParty2 > 0) {
    ...
    public void loadPartiesFromDatabase() {
        ...
        try {
            String fileName = "src/com/ironhack/rpg_simulator/assets/csv_files/";
